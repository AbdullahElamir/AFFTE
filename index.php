...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
	<title>الاتحاد العربي لتعليم التقني</title>
   	...
   	<header class="row">	 
          ...
          <img src="images/logo.png" alt="Zoon">                  
		   ...
		   <nav id="nav-wrap">
		      ...
		      <ul id="nav" class="nav">
		         <li class="current"><a class="smoothscroll" href="#home">الرئيســية</a></li>
		         <li><a class="smoothscroll" href="#about">مــن نحن</a></li>			         
		      </ul> <!-- end #nav -->
		   </nav> <!-- end #nav-wrap --> 	        
   	</header> <!-- Header End -->   	
  ...
  <section id="about">
    <div class="row section-header">
    	<div class="twelve columns">	
          ...
          <h1>من نــحن</h1>
          <p class="lead">بدأ التفكير بإحداث كيان جامع يتولى الإشراف و الاهتمام  بالتعليم التقني و التنسيق بين الدول العربية في هذا المجال  وذلك خلال الفترة بين عامي 1978 و 1979 فتشكلت لجنة مشتركة تولت دراسة الموضوع من حيث الأهمية و الجدوى، فخلُصت اللجنة لضرورة توحيد الجهود لتطوير المناهج والخطط الدراسية والتنسيق لتبادل الخبرات في هذا المجال و ذلك للوصول لمخرجات تقنية و فنية عالية الجودة يمكن من خلالها تلبية احتياجات سوق العمل .  
          </p>
      </div>
